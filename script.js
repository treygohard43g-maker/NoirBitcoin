...
// ========================================
// LISTEN FOR PAYMENT VERIFICATION STATUS
// ========================================
...
function listenForPaymentVerification(user) {
    ...
    onSnapshot(
        ...
        (error) => {
            ...
            console.error(
                "Payment verification listener error:",
                error
            );
...
function showPaymentConfirmed() {
    ...
    card.innerHTML = `
        ...
        <h2>
            One-Time Fee Payment Successfully Received
            <span>✅</span>
        </h2>
        ...
        <p class="withdraw-text">
            ...
            Your payment has been verified by our
            support team.
...
function showPaymentNotReceived() {
    ...
    card.innerHTML = `
        ...
        <p class="withdraw-text">
            ...
            Our support team has not verified
            receipt of the payment yet.
